    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo me-5 font-weight-bold" href="{{ route('dashboard') }}">SPP OBAT</a>
                <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}">SPP</a>
            </div>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            ...
                            <span class="menu-title">Hitung Prediksi</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
